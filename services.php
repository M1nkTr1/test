            ...
            <div class="flex-1 p-4">
                <form method="GET">
                    <div class="flex gap-3 items-center">
                        ...
                        <a href="services_add.php" class="text-white bg-slate-800 p-3">+ Thêm mới</a>
                    </div>
                </form>
            ...
            if (mysqli_num_rows($services) == 0) {
                ...
                ?>
                    ...
                    <div class="border border-gray-100 p-4 text-sm relative">
                        <a href="services_edit.php?ma=<?php echo $service['id'] ?>" class="material-symbols-outlined absolute -top-2 -right-2 p-2 border bg-white rounded-full hover:bg-slate-800 hover:text-white duration-200">
                            edit
                        </a>
