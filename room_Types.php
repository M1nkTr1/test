        ...
        <div class="flex-1 flex flex-col max-h-screen overflow-scroll">
            ...
            <div class="flex-1 p-4">
                <form method="GET">
                    <div class="flex gap-3 items-center">
                        ...
                        <a href="room_Types_add.php" class="text-white bg-slate-800 p-3">+ Thêm mới</a>
                    </div>
                </form>
            ...
            if (mysqli_num_rows($roomTypes) == 0) {
                ...
                while ($type = mysqli_fetch_array($roomTypes)) {
                    echo "<a href='/room_Types_edit.php?ma={$type['id']}' class='p-4 mt-4 hover:bg-gray-100 border border-gray-100 cursor-pointer duration-100'>";
